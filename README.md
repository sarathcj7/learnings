...
| # | Topic | Sub-files | Mastered | Status |
|---|---|---|---|---|
| 1 | [Networking & Protocols](fundamentals/networking-and-protocols/) | 5 | 0/5 | ⭕ |
| 2 | [APIs & Communication](fundamentals/apis-and-communication/) | 5 | 0/5 | ⭕ |
| 3 | [Scalability & Load Balancing](fundamentals/scalability-and-load-balancing/) | 5 | 0/5 | ⭕ |
| 4 | [Caching](fundamentals/caching/) | 5 | 0/5 | ⭕ |
| 5 | [Databases](fundamentals/databases/) | 7 | 0/7 | ⭕ |
| 6 | [Distributed Systems Theory](fundamentals/distributed-systems-theory/) | 4 | 0/4 | ⭕ |
| 7 | [Consensus & Coordination](fundamentals/consensus-and-coordination/) | 5 | 0/5 | ⭕ |
| 8 | [Distributed Transactions](fundamentals/distributed-transactions/) | 4 | 0/4 | ⭕ |
| 9 | [Messaging & Streaming](fundamentals/messaging-and-streaming/) | 5 | 0/5 | ⭕ |
| 10 | [Microservices Architecture](fundamentals/microservices-architecture/) | 5 | 0/5 | ⭕ |
| 11 | [Rate Limiting & Traffic Management](fundamentals/rate-limiting-and-traffic-management/) | 4 | 0/4 | ⭕ |
| 12 | [Distributed Data Structures](fundamentals/distributed-data-structures/) | 5 | 0/5 | ⭕ |
| 13 | [Storage Systems](fundamentals/storage-systems/) | 4 | 0/4 | ⭕ |
| 14 | [Search & Indexing](fundamentals/search-and-indexing/) | 4 | 0/4 | ⭕ |
| 15 | [Observability](fundamentals/observability/) | 4 | 0/4 | ⭕ |
| 16 | [Security](fundamentals/security/) | 4 | 0/4 | ⭕ |
| 17 | [Reliability & Resiliency](fundamentals/reliability-and-resiliency/) | 5 | 0/5 | ⭕ |
| 18 | [Batch & Stream Processing](fundamentals/batch-and-stream-processing/) | 4 | 0/4 | ⭕ |
| 19 | [Content Delivery & Edge](fundamentals/content-delivery-and-edge/) | 4 | 0/4 | ⭕ |
| 20 | [Capacity Planning & Estimation](fundamentals/capacity-planning-and-estimation/) | 4 | 0/4 | ⭕ |
...
| # | Case Study | Tier | Key Fundamentals | File | Status |
|---|---|---|---|---|---|
...
**Status**: All fundamentals and case studies written. Interview prep materials complete.  
**Next step**: Start with fundamentals → Question Bank → Flashcards → Related Case Study loop.
